...
const products = [
...

    {
        ...
        size: ["S"],
        color: "",
        desc: "Kaos putih Volcom lengan pendek cocok digunakan untuk aktivitas santai.",
    ...
    },
    {
        ...
        size: ["XS", "S"],
        color: "Hitam",
        desc: "Tank top rajut ribbed yang simpel dan mudah dipadukan. Bahan stretch nyaman dipakai seharian.",
        notes: "Kondisi baik, sudah dicuci bersih. Ada sedikit pilling halus di bagian dalam.",
        image: "",
        featured: true,
    },
    {
